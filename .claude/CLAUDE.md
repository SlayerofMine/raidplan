...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-28 (commit d6cc143). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 8.13/10 avg, hotspot health 6.35/10 (stable), worst `apps/web/src/editor/canvas/AttackPreviewLayer.tsx` at 1.8/10 · maintainability 9.35/10 · performance risk 3 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
