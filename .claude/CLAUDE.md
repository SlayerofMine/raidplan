...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-27 (commit 070574c). Confidence: 100%.
...
### Code health
Three co-equal signals: defect risk 8.44/10 avg, hotspot health 6.66/10 (stable), worst `apps/web/src/editor/canvas/AttackPreviewLayer.tsx` at 1.8/10 · maintainability 9.38/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `apps/web/src/editor/canvas/CanvasStage.tsx` — prior defect — impact −1.4
